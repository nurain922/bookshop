        ...
        <section class="invoice">
          ...
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
                <i class="fa fa-globe"></i>BookShopOnline Sdn Bhd.
          ...
          <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
              From
              <address>
                <strong>BookShopOnline Sdn Bhd.</strong><br>
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <p class="lead">Amount Due 2/22/2016</p>
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <a href="show" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
