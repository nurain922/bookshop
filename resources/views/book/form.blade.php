                  ...
                  <form action="\save" method="POST">
                    ...
                    ISBN :<input type="text" name="book_ISBN" class="form-control">
                     @if ($errors->has('book_ISBN'))
                                ...
                                @endif
                    Author :<input type="text" name="book_author" class="form-control">
                     @if ($errors->has('book_author'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('book_author') }}</strong>
                                    </span>
                                @endif
                    Publisher :<input type="text"  name="book_publisher" class="form-control">
                     @if ($errors->has('book_publisher'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('book_publisher') }}</strong>
                                    </span>
                                @endif
                    Price : <input type="text"  name="book_price" class="form-control">
